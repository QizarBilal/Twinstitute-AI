...
export default function AnalyticsPage() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-8 min-h-screen bg-black">
      {/* Header */}
      <motion.div
      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
          <div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">Institutional Analytics</h1>
